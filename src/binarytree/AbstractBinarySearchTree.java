...
public class AbstractBinarySearchTree {
	...
	/** Root node where whole binarytree starts. */
	public Node root;
	...
	/**
	 * Insert new element to binarytree.
	 * 
	 * @param element
	 *            Element to insert.
	 */
	 ...
	 * 如果左孩子或右孩子为空，直接将左孩子或右孩子代替原来的节点；
	 * 利用右子树最左的节点代替当前节点（左子树最右的孩子），然后将右子树最左节点的右子树挂在其父节点上；
	 * 中序遍历中前驱节点、后继节点；（搜索二叉树的中序遍历一定是有序的、升序）
	 * @param deleteNode
	...
	/**
	 * Put one node from binarytree (newNode) to the place of another (nodeToReplace).
	 * 
	 * @param nodeToReplace
	 *            Node which is replaced by newNode and removed from binarytree.
	 * @param newNode
	 *            New node.
	 * 
	...
	/**
	 * @param element
	 * @return true if binarytree contains element.
	 */
	...
	/**
	 * @return Minimum element in binarytree.
	 */
	...
	/**
	 * @return Maximum element in binarytree.
	 */
	...
	/**
	 * @return Number of elements in the binarytree.
	 */
	public int getSize() {
		return size;
	}
