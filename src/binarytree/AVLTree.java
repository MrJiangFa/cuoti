 ...
 * 
 * AVL binarytree implementation.
 * 
 * In computer science, an AVL binarytree is a self-balancing binary search binarytree, and
 * it was the first such data structure to be invented.[1] In an AVL binarytree, the
 ...
 * cases, where n is the number of nodes in the binarytree prior to the operation.
 * Insertions and deletions may require the binarytree to be rebalanced by one or more
...
public class AVLTree extends AbstractSelfBalancingBinarySearchTree {
     ...
     * 
     *      AVL binarytree insert method also balances binarytree if needed. Additional
     *      height parameter on node is used to track if one subtree is higher
     *      than other by more than one, if so AVL binarytree rotations is performed
     *      to regain balance of the binarytree.
     */
    @Override
    ...
    /**
     * Node of AVL binarytree has height and balance additional properties. If balance
