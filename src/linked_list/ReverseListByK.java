...
public class ReverseListByK {
    ...
    /**
     * Reverse a link linked_list between begin and end exclusively
     * an example:
     * a linked linked_list:
     * 0->1->2->3->4->5->6
     * |           |
     * begin       end
     ...
     * begin end
     *
     * @return the reversed linked_list's 'begin' node, which is the precedence of node end
     */
    //非递归法
